...
# Ensure the app package is importable and pull its real DB URL / metadata,
# so migrations always target the same database and schema the app itself
# uses (settings.DATABASE_URL respects the DATABASE_URL env var, exactly like
